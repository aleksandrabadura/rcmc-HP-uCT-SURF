%% wczytanie pliku .svs
% wybierz obraz .svs
% wybierz rozdzielczosc obrazu pogladowego (page 2)
% zaznacz ROI, potwierdz dwuklikiem
% wybierz rozdzielczosc obrazu ROI (page 4)
% zapisano ROI jako .tif

[filename, pathname] = uigetfile( ...
    {'*.tif*;*.png;*.jpg;*.svs;*.scn; *.mrxs*', 'All Image Files (*.tif*, *.png, *.jpg, *.svs, *.scn)';
